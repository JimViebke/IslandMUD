...
public:
	...
	const static string
		...
		XML_SKILL_SWORDSMANSHIP,
		XML_SKILL_ARCHERY,
		XML_SKILL_FOREST_VISIBILITY;
	...
	const static int
		SWORDSMANSHIP_SKILL_MIN,
		SWORDSMANSHIP_SKILL_MAX,
		ARCHERY_SKILL_MIN,
		ARCHERY_SKILL_MAX,
		FOREST_VISIBILITY_SKILL_MIN,
		FOREST_VISIBILITY_SKILL_MAX;
};
