...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/islandmud-server.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/islandmud-server.exe: ${OBJECTFILES}
...
${OBJECTDIR}/craft.o: craft.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/craft.o craft.cpp
...
${OBJECTDIR}/non_player_character.o: non_player_character.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/non_player_character.o non_player_character.cpp

${OBJECTDIR}/npc_enemy.o: npc_enemy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy.o npc_enemy.cpp

${OBJECTDIR}/npc_enemy_fighter.o: npc_enemy_fighter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy_fighter.o npc_enemy_fighter.cpp

${OBJECTDIR}/npc_enemy_worker.o: npc_enemy_worker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy_worker.o npc_enemy_worker.cpp

${OBJECTDIR}/npc_unaffiliated.o: npc_unaffiliated.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_unaffiliated.o npc_unaffiliated.cpp
...
${OBJECTDIR}/player_character.o: player_character.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/player_character.o player_character.cpp
...
${OBJECTDIR}/recipes.o: recipes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/recipes.o recipes.cpp
...
${OBJECTDIR}/room_side.o: room_side.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/room_side.o room_side.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/islandmud-server.exe
