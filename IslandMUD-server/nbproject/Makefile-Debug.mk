...
${OBJECTDIR}/craft.o: craft.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/craft.o craft.cpp
...
${OBJECTDIR}/non_player_character.o: non_player_character.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/non_player_character.o non_player_character.cpp

${OBJECTDIR}/npc_enemy.o: npc_enemy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy.o npc_enemy.cpp

${OBJECTDIR}/npc_enemy_fighter.o: npc_enemy_fighter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy_fighter.o npc_enemy_fighter.cpp

${OBJECTDIR}/npc_enemy_worker.o: npc_enemy_worker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_enemy_worker.o npc_enemy_worker.cpp

${OBJECTDIR}/npc_unaffiliated.o: npc_unaffiliated.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/npc_unaffiliated.o npc_unaffiliated.cpp
...
${OBJECTDIR}/player_character.o: player_character.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/player_character.o player_character.cpp
...
${OBJECTDIR}/recipes.o: recipes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/recipes.o recipes.cpp
...
${OBJECTDIR}/room_side.o: room_side.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/room_side.o room_side.cpp
