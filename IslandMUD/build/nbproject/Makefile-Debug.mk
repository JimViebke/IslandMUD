...
${OBJECTDIR}/NPC/non_player_character.o: NPC/non_player_character.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/non_player_character.o NPC/non_player_character.cpp

${OBJECTDIR}/NPC/npc_enemy.o: NPC/npc_enemy.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_enemy.o NPC/npc_enemy.cpp

${OBJECTDIR}/NPC/npc_enemy_bodyguard.o: NPC/npc_enemy_bodyguard.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_enemy_bodyguard.o NPC/npc_enemy_bodyguard.cpp

${OBJECTDIR}/NPC/npc_enemy_corporal.o: NPC/npc_enemy_corporal.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_enemy_corporal.o NPC/npc_enemy_corporal.cpp

${OBJECTDIR}/NPC/npc_enemy_fighter.o: NPC/npc_enemy_fighter.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_enemy_fighter.o NPC/npc_enemy_fighter.cpp

${OBJECTDIR}/NPC/npc_enemy_worker.o: NPC/npc_enemy_worker.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_enemy_worker.o NPC/npc_enemy_worker.cpp

${OBJECTDIR}/NPC/npc_neutral.o: NPC/npc_neutral.cpp 
	${MKDIR} -p ${OBJECTDIR}/NPC
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NPC/npc_neutral.o NPC/npc_neutral.cpp
...
${OBJECTDIR}/item/bloomery.o: item/bloomery.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/item/bloomery.o item/bloomery.cpp

${OBJECTDIR}/item/chest.o: item/chest.cpp 
	${MKDIR} -p ${OBJECTDIR}/item
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/item/chest.o item/chest.cpp

${OBJECTDIR}/item/container.o: item/container.cpp 
	${MKDIR} -p ${OBJECTDIR}/item
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/item/container.o item/container.cpp

${OBJECTDIR}/item/equipment.o: item/equipment.cpp 
	${MKDIR} -p ${OBJECTDIR}/item
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/item/equipment.o item/equipment.cpp
...
${OBJECTDIR}/network/connection.o: network/connection.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/network/connection.o network/connection.cpp

${OBJECTDIR}/network/network.o: network/network.cpp 
	${MKDIR} -p ${OBJECTDIR}/network
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/network/network.o network/network.cpp
...
${OBJECTDIR}/server/server.o: server/server.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/server/server.o server/server.cpp
